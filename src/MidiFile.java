...
public class MidiFile
{
	...
	public List<MidiEvent>[] events;    // The raw MidiEvents, one list per track, event track
	public List<MidiTrack>   tracks;    // The tracks of the midifile that have notes
	public int               trackmode;  // 0 (single track), 1 (simultaneous tracks), 2 (independent tracks) USHORT
	public TimeSignature     timeSig;    // The time signature
	public int               quarternote;     // The number of pulses per quarter note
	public int               totalPulses;     // The total length of the song, in pulses
	public boolean           trackPerChannel; // True if we've split each channel into a track
	public int               numEventTracks;     // Track = instrument notes, Event Track = MIDI Tracks

	public MidiFile(String fileName) throws MidiException, IOException, UnsupportedEncodingException
	{
